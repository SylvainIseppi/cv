	...
	<!-- collone gauche-->
		<div class=" gauche column small-12  desk-4 ">
			<div class="presentation">
				<div class="row ">
				<!-- photo (a modifier) avec nom prenom et métier-->
					...
					<div class="column small-12 medium-6 desk-12">
						<div class="column small-2 medium-hide desk-show desk-2">
							<span class="fa fa-user"></span>
						</div>
						<div class="description column small-10 medium-12 desk-10">
							Sinistra longiores cingulis perspicue in cultu nimia effigiatae longiores cultu animalium in crebris nimia crebris longiores animalium effigiatae in collis.
					...
					<div class="column small-12">
						<div class="column small-12 medium-6 desk-12">
							<div class="row">
								...
								<div class="text column small-10">
									<p>Compétences:</p>
									<div class="textexperience colum smal-12"></div>
										Adobe photoshop
									...
									<div class="experience ">
										<div class="nonaquise">
											<div class="aquise" style="width:80%">
													<span class="pourcent fa fa-circle"></span>
											</div>
										</div>
									</div>
		...
		<!-- collone de droite-->
		<div class=" column small-12 medium-12 desk-8">
